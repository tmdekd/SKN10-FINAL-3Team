...
from .views import LoginView, RefreshView, Logoutview, JWTAPIView, login_page, main_page, profile
...
urlpatterns = [
    ...
    path('api/profile/', JWTAPIView.as_view(), name='profile-api'),  # 프로필 API
